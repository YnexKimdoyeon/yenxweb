...
export function GET() {
  ...
  lines.push("")
  lines.push(
    "> 영업사원이 아닌 개발자가 직접 현장을 방문해 업무를 분석하고, 중소기업의 디지털 전환(DX)과 AI 전환(AX)을 100% 맞춤으로 구축하는 IT 전문 기업입니다. 업무자동화(RPA)·ERP·매크로·웹 크롤링부터 AI 업무자동화·문서 자동화·상담 챗봇까지 개발하며, 전국 무료 현장 방문으로 시작합니다.",
  )
  lines.push("")
  lines.push("## 회사 정보")
  lines.push("")
